...
class FileTests: XCTestCase {
    ...
    func testLoadFile() {
        let testBundle = Bundle(for: type(of: self))
        guard let path = testBundle.path(forResource: "inc", ofType: "cocoalisp") else {
            XCTFail("Can't find file inc.cocoalisp")
            return
        }
    ...
    func testCommentsInFile() {
        let testBundle = Bundle(for: type(of: self))
        guard let path = testBundle.path(forResource: "incB", ofType: "cocoalisp") else {
            XCTFail("Can't find file incB.cocoalisp")
            return
        }
    ...
    func testMapLiteralAcrossMultipleLinesInAFile() {
        let testBundle = Bundle(for: type(of: self))
        guard let path = testBundle.path(forResource: "incC", ofType: "cocoalisp") else {
            XCTFail("Can't find file incC.cocoalisp")
            return
        }
