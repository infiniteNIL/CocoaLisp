...
enum Printer {
    ...
    static func print(_ expr: DataType?, printReadably: Bool = false) -> String {
        ...
        case let hash as HashMap:
            return CocoaLisp.print(hash.elements,
                                   openBracket: "{", closeBracket: "}",
                                   printReadably: printReadably)

        case let list as List:
            return CocoaLisp.print(list.elements,
                                   openBracket: "(", closeBracket: ")",
                                   printReadably: printReadably)
        ...
        case let vector as Vector:
            return CocoaLisp.print(vector.elements,
                                   openBracket: "[", closeBracket: "]",
                                   printReadably: printReadably)
...
private func printString(_ string: CocoaLispString, printReadably: Bool) -> String {
